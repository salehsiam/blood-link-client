  ...
  return (
    <section className="max-w-7xl mx-auto rounded-3xl relative py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Eligible Card */}
        <div className="p-8 bg-secondary border border-green-300 shadow-lg rounded-xl backdrop-blur-lg transition duration-300">
        ...
        {/* Not Eligible Card */}
        <div className="p-8 bg-secondary border border-primary shadow-lg rounded-xl backdrop-blur-lg transition duration-300">
